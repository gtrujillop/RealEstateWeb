...
describe Consultant do
	describe "password validations" do
    	...
    	expect(Consultant.new({ username: "user_1",birth_date: '11-09-1988', first_name: "Juan", last_name: "Perez", email:'my_email@email.com', is_active: true }).save).to be false
  	end

  	it "fails because password is short" do
    	expect(Consultant.new({username: "user_1",birth_date: '11-09-1988', first_name: "Juan", last_name: "Perez", password: 'blah', email:'my_email@email.com', is_active: true}).save).to be false
  	end
