...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    #
    primary.item :propiedades, 'Propiedades', '#', if: -> { current_user } do |sub_nav|
      sub_nav.item :show, 'Mis Propiedades', '#'
      sub_nav.item :add, 'Nueva propiedad', '#'
    end

    primary.item :negocios, 'Negocios', '#', if: -> { current_user } do |sub_nav|
